...
→ [RENDER_MANUAL_SETUP.md](RENDER_MANUAL_SETUP.md) → Method 1 (Automatic)
...
4. Choose your path:
   ├─ DOCKER_DEPLOYMENT.md (for Docker)
...
**Render Deployment**
- Automatic: RENDER_MANUAL_SETUP.md → Method 1
- Manual: RENDER_MANUAL_SETUP.md → Method 3
- Docker on Render: RENDER_MANUAL_SETUP.md → Method 2
- Optimization: RENDER_DEPLOYMENT.md

**Docker**
- Quick start: DOCKER_DEPLOYMENT.md → Quick Start
- Compose: docker-compose.yml
- Production: DOCKER_DEPLOYMENT.md → Production
- Troubleshooting: DOCKER_DEPLOYMENT.md → Troubleshooting

**Configuration**
- Environment variables: All deployment guides have this section
- FFmpeg settings: replit.md → Video Conversion Settings
- Download strategies: DEPLOYMENT_SUMMARY.md
- Memory optimization: RENDER_DEPLOYMENT.md, DOCKER_DEPLOYMENT.md

**Troubleshooting**
- Render issues: RENDER_MANUAL_SETUP.md → Troubleshooting
...
**Cookies**
- Why needed: COOKIE_SETUP_GUIDE.md → Problem section
- How to set up: COOKIE_SETUP_GUIDE.md → Quick Steps
- Troubleshooting: COOKIE_SETUP_GUIDE.md → Troubleshooting
...
A: DEPLOYMENT_SUMMARY.md and replit.md → Recent Changes

## 🆘 Still Need Help?

1. **Check the right troubleshooting section:**
   - Render: RENDER_MANUAL_SETUP.md → Troubleshooting
   - Docker: DOCKER_DEPLOYMENT.md → Troubleshooting
   - Cookies: COOKIE_SETUP_GUIDE.md → Troubleshooting
...
3. **Common issues:**
   - "Build failed" → Check build.sh exists
   - "Health check failed" → Wait 30s, check /health endpoint
   - "Download failed" → Try COOKIE_SETUP_GUIDE.md
   - "Out of memory" → Use shorter videos on free tier
